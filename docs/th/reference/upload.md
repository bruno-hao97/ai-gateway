---
title: Upload
description: อัปโหลดรูปและวิดีโอบน Gommo V2
---

# Upload

| การดำเนินการ | Gommo public API (แนะนำ) | Gateway (ทางเลือก) |
|-----------|------------------------|-------------------|
...
Auth: `Authorization: Bearer` และ/หรือ form `access_token` multipart มี `domain`, `project_id`
