...
Hai bước: **search voices** → **create TTS**.
...
**Audio TTS** → Fetch voices → Run TTS. **Audio lists** cho lịch sử.

## Tiếp theo

- [Audio reference](../reference/audio.md)
- [TTS media job](./video-music-job.md) — `/gateway/jobs/tts` vs `/gateway/audio/tts`
